...
- A playable battle screen with a top-to-bottom order of the compact Level/Moves/Levels HUD row, then `EnemyPanel`, then `RoundModifierPanel`, then the widened 9x9 `BoardView`, placeholder `TileView` tiles, hidden inactive hero party panel, status text, result overlay, and clean Next Level, Retry, and Levels result actions (Stage 64.1).
