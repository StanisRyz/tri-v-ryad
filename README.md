...
- Board gameplay rules (match/swap logic, gravity board-state logic, booster rules, special tile rules, result flow) are unchanged. Stage 56 remains the ice obstacle core.
