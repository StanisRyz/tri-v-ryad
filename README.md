...
- No procedural ice placement, no new ice-specific win goals, and no changes to enemy damage/stars/result flow/boosters/special tile rules beyond the ice-obstacle interactions above. Stage 57 will generate `frozen_cells` procedurally for ice-archetype levels.
