...
- No real ice/frozen-cell behavior, blockers, chains, or portals beyond the current Stage 54 v0.1 procedural holes generator (`holes` archetype now generates real inactive-cell masks; `normal`/`ice` remain full 9x9) unless explicitly requested.
