...
- No real procedural holes, real ice/frozen-cell behavior, blockers, chains, or portals beyond the current Stage 53 v0.1 active-mask core plus segment-based gravity/refill (wired through but every generated mask is still full 9x9) unless explicitly requested.
