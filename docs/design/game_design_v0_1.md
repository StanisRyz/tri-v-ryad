...
- No real active-cell board masks, real procedural holes, real ice/frozen-cell behavior, blockers, chains, or portals beyond the current Stage 51 v0.1 placeholder (full 9x9 board, empty frozen cells) unless explicitly requested.
