...
- No real procedural holes, real ice/frozen-cell behavior, blockers, chains, or portals beyond the current Stage 52 v0.1 active-mask core (wired through but every generated mask is still full 9x9) unless explicitly requested.
- No gravity/refill changes for masked (non-rectangular) boards or inactive-cell visuals until Stage 53/55 are explicitly requested.
