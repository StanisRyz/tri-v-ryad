...
func _init(config_background_id: String = "", config_display_name: String = "", config_placeholder_color: Color = Color.BLACK, config_texture_path: String = "", config_asset_key: String = "") -> void:
